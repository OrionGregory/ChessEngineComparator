...
class AdvancedChessBot:
    ...
    def evaluate_position(self, board):
        ...
        total_score = material_score + position_score * 0.3
    ...
    def select_move(self):
        ...
        try:
            ...
            # Use random move for the first few moves for variety and speed
    ...
    def make_move(self, move_uci):
        ...
        try:
            ...
            if move in self.board.legal_moves:
                ...
                # If the move is not legal in the current position, print some debug info
                if self.debug:
